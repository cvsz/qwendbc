---
name: linux-service-installer
description: linux-service-installer skill
---
...
2. Inspect current-state evidence relevant to `linux-service-installer` before proposing change.
