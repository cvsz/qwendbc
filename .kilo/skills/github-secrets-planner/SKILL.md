---
name: github-secrets-planner
description: github-secrets-planner skill
---
...
2. Inspect current-state evidence relevant to `github-secrets-planner` before proposing change.
