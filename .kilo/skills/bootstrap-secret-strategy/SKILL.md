---
name: bootstrap-secret-strategy
description: bootstrap-secret-strategy skill
---
...
2. Inspect current-state evidence relevant to `bootstrap-secret-strategy` before proposing change.
