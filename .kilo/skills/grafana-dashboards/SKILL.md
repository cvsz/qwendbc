...
description: grafana-dashboards skill
---

# zomega Skill 041: grafana-dashboards

## Owner
`zomega-sre`

## Objective
Execute `grafana-dashboards` as a production engineering operation with traceable evidence.

## Procedure
1. Validate the supplied objective, scope, environment, and constraints.
2. Inspect current-state evidence relevant to `grafana-dashboards` before proposing change.
