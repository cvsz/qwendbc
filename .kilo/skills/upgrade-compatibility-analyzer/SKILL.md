---
name: upgrade-compatibility-analyzer
description: upgrade-compatibility-analyzer skill
---
...
2. Inspect current-state evidence relevant to `upgrade-compatibility-analyzer` before proposing change.
