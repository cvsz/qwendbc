---
name: full-autonomous-build-mode
description: full-autonomous-build-mode skill
---
...
2. Inspect current-state evidence relevant to `full-autonomous-build-mode` before proposing change.
