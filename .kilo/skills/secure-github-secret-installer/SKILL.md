---
name: secure-github-secret-installer
description: secure-github-secret-installer skill
---
...
2. Inspect current-state evidence relevant to `secure-github-secret-installer` before proposing change.
