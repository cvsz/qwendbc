---
name: upgrade-script
description: upgrade-script skill
---

# zomega Skill 097: upgrade-script

## Owner
`zomega-release`

## Objective
Execute `upgrade-script` as a production engineering operation with traceable evidence.

## Procedure
1. Validate the supplied objective, scope, environment, and constraints.
2. Inspect current-state evidence relevant to `upgrade-script` before proposing change.
