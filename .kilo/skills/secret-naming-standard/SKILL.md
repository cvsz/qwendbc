---
name: secret-naming-standard
description: secret-naming-standard skill
---
...
2. Inspect current-state evidence relevant to `secret-naming-standard` before proposing change.
