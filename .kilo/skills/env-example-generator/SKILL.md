...
description: env-example-generator skill
---

# zomega Skill 028: env-example-generator

## Owner
`zomega-architect`

## Objective
Execute `env-example-generator` as a production engineering operation with traceable evidence.

## Procedure
1. Validate the supplied objective, scope, environment, and constraints.
2. Inspect current-state evidence relevant to `env-example-generator` before proposing change.
