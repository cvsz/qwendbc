---
name: cpu-only-optimization
description: cpu-only-optimization skill
---

# zomega Skill 017: cpu-only-optimization

## Owner
`zomega-architect`

## Objective
Execute `cpu-only-optimization` as a production engineering operation with traceable evidence.

## Procedure
1. Validate the supplied objective, scope, environment, and constraints.
2. Inspect current-state evidence relevant to `cpu-only-optimization` before proposing change.
