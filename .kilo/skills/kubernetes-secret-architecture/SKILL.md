---
name: kubernetes-secret-architecture
description: kubernetes-secret-architecture skill
---
...
2. Inspect current-state evidence relevant to `kubernetes-secret-architecture` before proposing change.
