---
name: universal-bash-installer
description: universal-bash-installer skill
---

# zomega Skill 095: universal-bash-installer

## Owner
`zomega-devops`

## Objective
Execute `universal-bash-installer` as a production engineering operation with traceable evidence.

## Procedure
1. Validate the supplied objective, scope, environment, and constraints.
2. Inspect current-state evidence relevant to `universal-bash-installer` before proposing change.
