---
name: secret-rotation-system
description: secret-rotation-system skill
---
...
2. Inspect current-state evidence relevant to `secret-rotation-system` before proposing change.
